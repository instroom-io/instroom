...
export async function GET(
  ...
  try {
    ...
    // `id` here is the BrandInfluencer.id — every caller (Influencer List,
    // Pipeline, Post Tracker, Brand Partners) passes it directly, and it's
    // also what activity logs are written against as entity_id.
